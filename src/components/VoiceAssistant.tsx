...
const VoiceAssistant: React.FC = () => {
    ...
    useEffect(() => {
        const handleActivate = () => {
            ...
            speak(t("voice_assistant_active"));
        ...
        window.addEventListener('activate-voice-assistant', handleActivate);
        return () => window.removeEventListener('activate-voice-assistant', handleActivate);
    }, []);

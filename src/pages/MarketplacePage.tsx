	...
	return (
		<div className="min-h-screen bg-gradient-to-b from-emerald-50 via-slate-50 to-white pb-16">
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
				{/* Search and Filters */}
				<div className="bg-white/95 backdrop-blur-xl rounded-[2rem] shadow-2xl shadow-emerald-900/10 border border-white/70 mb-8 overflow-hidden">
								...
								<div
									...
									<div className="relative h-56 bg-gradient-to-br from-emerald-100 via-teal-50 to-emerald-200 flex items-center justify-center overflow-hidden">
										{primaryImage ? (
											...
											<>
												<div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.35),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(250,204,21,0.35),_transparent_32%)] z-0"></div>
									...
									<div className="p-5 flex flex-col flex-grow">
										<div className="mb-3">
											...
											<span
												className={`ml-2 text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-md ${product.origin === "INTERNATIONAL"
